# Django settings for bookadoc project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bookadoc',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'zjtiapsk@_6tj&op0im0alu8y5=urxk3^)i^u8uvm2+r%4u1(c'
